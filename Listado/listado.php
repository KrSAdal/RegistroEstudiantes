    ...
    <body class="yup">
        <div class="principal">
            ...
            <form id="form2" name="form2" method="POST" action="listado.php">
                    ...
                    <table class="table">
                        <thead>
                            <tr class="filters">
                                <th>
                                    Grado
                                    <select name="buscarGrado" class="form-control mt-2"
                                ...
                                <th>
                                    Carrera
                                    <select name="buscarCarrera" class="form-control mt-2"
                                        style="border: #bababa 1px solid; color:#000000;">
                ...
                <?php
                if ($_POST["buscarGrado"] == 'Todos' and $_POST["buscarCarrera"] == 'Todos') {
                    $filtro = '';
                } else {
                    if ($_POST["buscarGrado"] !== 'Todos' and $_POST["buscarCarrera"] == 'Todos') {
                        $filtro = "WHERE grado = '" . $_POST["buscarGrado"] . "'";
                    }
                    if ($_POST["buscarGrado"] == 'Todos' and $_POST["buscarCarrera"] !== 'Todos') {
                        $filtro = "WHERE carrera = '" . $_POST["buscarCarrera"] . "'";
                    }
                    if ($_POST["buscarGrado"] !== 'Todos' and $_POST["buscarCarrera"] !== 'Todos') {
                        $filtro = "WHERE grado = '" . $_POST["buscarGrado"] . "' AND carrera = '" . $_POST["buscarCarrera"] . "'";
                    }
                }
                ?>
            </form>
